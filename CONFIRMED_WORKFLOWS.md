...
- **An-/Abwesenheiten** sind zusätzlich über **Doku → An-/Abwesenheiten** erreichbar. Der Weg über **Doku-Erweitert → An-/Abwesenheiten** bleibt ebenfalls bestätigt.
...
- **An-/Abwesenheiten** können außerdem über **Doku** geöffnet werden; der Weg über **Doku-Erweitert** bleibt bestätigt.
...
**Bestätigter alternativer Zugang:** Die Übersicht **An-/Abwesenheiten** kann auch über **Doku → An-/Abwesenheiten** geöffnet werden. Ab der geöffneten Übersicht bleibt der Ablauf identisch. Der Weg über **Doku-Erweitert → An-/Abwesenheiten** bleibt ebenfalls bestätigt.
...
1. Zuerst **Berichte** oder **Durchführungsnachweis** öffnen. Den Durchführungsnachweis erreichst du über **Doku → Durchführungsnachweis**.
2. Solange einer dieser beiden Bereiche geöffnet ist, bleibt links die Bewohnerübersicht sichtbar.
...
3. Unten mittig erscheint der Bereich **Dokumente**.
4. Dort das gewünschte bereits vorhandene Dokument suchen und auswählen, sofern es in der Dateiablage hinterlegt ist.
5. Das vorhandene Dokument einmal per Doppelklick öffnen und kurz warten, bis sich Word öffnet. Den Doppelklick nicht mehrfach ausführen.

Dieser Ablauf gilt ausschließlich für das Finden und Öffnen bereits vorhandener Dokumente. DokoHilf leitet hier nicht zum Hochladen, Löschen, Umbenennen, Bearbeiten oder Verschieben an.
