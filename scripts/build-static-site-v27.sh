...
grep -q "HOTFIX_REVISION = '20260807-static-supertonic-guides-v28-3'" "$SITE_DIR/service-worker.js"
...
echo "DokoHilf $BUILD_ID mit kostenloser statischer Supertonic-F1-Stimme für bestätigte Guides, lokaler Supertonic-Stimme nur für noch nicht vorbereitete freie Antworten, ohne Systemstimme, iOS-/Android-QA, Detailhilfe und direkten Anleitungen gebaut."
