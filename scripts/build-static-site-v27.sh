...
test -s "$SITE_DIR/assets/pwa-install-v69.css"
test -s "$SITE_DIR/assets/pwa-install-v69.js"
...
grep -q "pwa-install-v69.css?v=$BUILD_ID" "$SITE_DIR/index.html"
grep -q "pwa-install-v69.js?v=$BUILD_ID" "$SITE_DIR/index.html"
...
grep -q "pwa-install-v69.css?v=$BUILD_ID" "$SITE_DIR/service-worker.js"
grep -q "pwa-install-v69.js?v=$BUILD_ID" "$SITE_DIR/service-worker.js"
...
grep -q '__DOKOHILF_PWA_INSTALL_V69__' "$SITE_DIR/assets/pwa-install-v69.js"
