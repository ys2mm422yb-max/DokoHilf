...
@media(max-width:700px){
  ...
  html[data-dokohilf-ui="v29"] .mode-card{
    grid-template-columns:54px minmax(0,1fr) 34px!important;column-gap:12px!important;align-items:center!important;
    min-height:94px!important;padding:11px 13px!important;border-radius:21px!important;
  }
  html[data-dokohilf-ui="v29"] .mode-icon{
    width:50px!important;height:50px!important;align-self:center!important;justify-self:center!important;margin:0!important;transform:none!important;
  }
  html[data-dokohilf-ui="v29"] .mode-icon svg{width:27px!important;height:27px!important}
  html[data-dokohilf-ui="v29"] .mode-text{
    min-width:0!important;align-self:center!important;display:flex!important;flex-direction:column!important;justify-content:center!important;margin:0!important;
  }
  ...
  html[data-dokohilf-ui="v29"] .mode-arrow{
    width:34px!important;height:34px!important;font-size:26px!important;align-self:center!important;justify-self:center!important;margin:0!important;
  }
