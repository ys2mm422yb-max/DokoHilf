(() => {
  ...
  function orientationHelp(text) {
    ...
    if (/\b(massnahmen ohne zeitangabe|massnahme ohne zeitangabe)\b/.test(n)) {
      return 'Wähle beim gewünschten Bewohner ganz oben in der festen grünen Leiste Doku. Darunter erscheint der Durchführungsnachweis. Dort findest du Maßnahmen ohne Zeitangabe. Klicke auf den kleinen Pfeil links daneben, um sie zu öffnen.';
    }
