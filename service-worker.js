...
const CORE_FILES = [
  ...
  './index.html',
  './version.json',
  './assets/guide-audio-catalog.json?v=20260812-40',
  './assets/styles.css?v=20260812-40',
  './assets/premium-ui-v25.css?v=20260812-40',
  './assets/premium-ui-v26.css?v=20260812-40',
  './assets/premium-ui-v27.css?v=20260812-40',
  './assets/ux-v27.css?v=20260812-40',
  './assets/voice-stage-balance-v27.css?v=20260812-40',
  './assets/direct-guides-chat-v27.css?v=20260812-40',
  './assets/v29-ui.css?v=20260812-40',
  './assets/card-axis-fix-v29.css?v=20260812-40-cardaxis1',
  './assets/guide-library-v29.css?v=20260812-40-library1',
  './assets/ui-polish-v35.css?v=20260812-40-ui1',
  './assets/voice-polish-v36.css?v=20260812-40-voice1',
  './assets/ux-polish-v42.css?v=20260812-40-ux42',
  './assets/update-manager.js?v=20260812-40',
  './assets/mobile-audio-fix.js?v=20260812-40',
  './assets/routing-fix.js?v=20260812-40',
  './assets/conversation-intelligence.js?v=20260812-40',
  './assets/clarification-ui.js?v=20260812-40',
  './assets/detail-help-v27.js?v=20260812-40',
  './assets/smart-help-v29.js?v=20260812-40',
  './assets/guide-progress.js?v=20260812-40',
  './assets/orientation-help-v29.js?v=20260812-40',
  './assets/release-polish-v29.js?v=20260812-40',
  './assets/durchfuehrungs-workflows-v29.js?v=20260812-40',
  './assets/voice-focus-mode.js?v=20260812-40',
  './assets/local-voice-v28.js?v=20260812-40',
  './assets/experience-v27.js?v=20260812-40',
  './assets/detail-help-polish-v27.js?v=20260812-40',
  './assets/detail-help-render-sync-v27.js?v=20260812-40',
  './assets/context-voice-hotfix-v28.js?v=20260812-40',
  './assets/ux-v27.js?v=20260812-40',
  './assets/v29-ui.js?v=20260812-40',
  './assets/mobile-polish-v29.js?v=20260812-40-cardaxis1',
  './assets/local-voice-gate-v28.js?v=20260812-40',
  './assets/direct-guides-v27.js?v=20260812-40',
  './assets/direct-guide-copy-v29.js?v=20260812-40',
  './assets/guide-library-v29.js?v=20260812-40-library1',
  './assets/report-guide-hotfix-v43.js?v=20260812-40',
  './assets/ui-polish-v35.js?v=20260812-40-ui1',
  './assets/voice-polish-v36.js?v=20260812-40-voice1',
  './assets/ux-polish-v42.js?v=20260812-40-ux42',
  './assets/app.js?v=20260812-40',
