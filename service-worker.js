...
const CORE_FILES = [
  ...
  './index.html',
  './version.json',
  './assets/styles.css?v=20260805-14',
  './assets/update-manager.js?v=20260805-14',
  './assets/mobile-audio-fix.js?v=20260805-14',
  './assets/routing-fix.js?v=20260805-14',
  './assets/app.js?v=20260805-14',
